...
const Setup = preload("src/ldtk-setup.gd")
...
func _import(
    ...
    # pre-import
    Setup.pre_import(world_data, options)
    ...
    # fail if there is uses external levels
    # TODO  make support to it
